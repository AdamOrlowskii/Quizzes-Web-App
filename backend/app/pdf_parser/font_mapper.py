    ...
    try:
        ...
        if "cmap" in ttfont:
            ...
            if cmap:
                ...
                print(
                    f"    SUCCESS: Extracted {len(char_map)} characters from FontFile2"
                )
                ...
                print("    ERROR: No suitable cmap found in font")
        else:
            print("    ERROR: No cmap table in font")
...
def _extract_font_mappings(pdf_bytes: bytes, xref_table: dict) -> dict:
    ...
    if ff2_cmap:
        fontfile2_cmaps.append(ff2_cmap)
        print("    Added to fontfile2_cmaps list")
